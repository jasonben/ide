...
# Base16 Catppuccin Macchiato - Shell color setup script
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg cad3f5 # forground
  printf $printf_template_custom Ph 24273a # background
  printf $printf_template_custom Pi cad3f5 # bold color
  printf $printf_template_custom Pj 363a4f # selection color
  printf $printf_template_custom Pk cad3f5 # selected text color
  printf $printf_template_custom Pl cad3f5 # cursor
  printf $printf_template_custom Pm 24273a # cursor text
else
